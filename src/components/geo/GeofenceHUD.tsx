// src/components/geo/GeofenceHUD.tsx
'use client';
...
export default function GeofenceHUD() {
    const [checkin, setCheckin] = useState<CheckinDetail | null>(null);

    useEffect(() => {
        const onCheckin = (e: Event) => {
            const detail = (e as CustomEvent<CheckinDetail>).detail;
            setCheckin(detail);
        };
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-3 flex gap-2">
                            <Button
                                ...
                                onClick={() => {
                                    // TODO: trigger your check-in POST / state update here if needed
                                    setCheckin(null);
                                }}
                            >
                                Check in
