    ...
    <div className="space-y-10">
      ...
      {selectedMonument && (
        <MonumentDetailModal
          ...
          customStyle="bg-gradient-to-r from-green-700 via-green-600 to-green-400 text-white hover:opacity-90"
        />
      )}
    </div>
  );
    ...
    <div className="flex items-center justify-between gap-3 pt-4">
      ...
      <div className="flex items-center gap-1">
        <Button
          variant="ghost"
          size="sm"
          className="cursor-pointer h-8 text-green-600 hover:bg-green-50 dark:hover:bg-slate-800"
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="cursor-pointer rounded-full text-green-600 hover:bg-green-50 dark:hover:bg-slate-800"
          >
